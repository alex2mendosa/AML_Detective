...
get_ipython().system('jupyter nbconvert --to python 4_5_2_research_assistant.ipynb')
...
llm_class_generation = ChatOpenAI(
    ...
    max_tokens=1000,          # CORRECT: 3 fields with descriptions = ~50-80 tokens
...
llm_agg_summaries = ChatOpenAI(
    model="gpt-4.1",       # CORRECT: You need the reasoning power here!
...
def google_search(query,  num_results = 5, hl="en", lr="lang_en", dateRestrict="y2", wikipedia_lang="en"):
    ...
    ## orterms
    #orterms_for_search = extract_orterms_from_query(translated_query, orterms_for_search, hl )
...
initial_message = [ HumanMessage(content = "Danske Bank" )  ]
